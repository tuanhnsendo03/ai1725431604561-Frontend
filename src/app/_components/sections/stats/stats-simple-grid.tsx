          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Experience Ultimate Flexibility with Premium Car Rentals
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Choose from a Wide Range of Vehicles for Your Every Need – Reliable, Convenient, and Hassle-Free Car Rental Services
              </p>
            </div>
